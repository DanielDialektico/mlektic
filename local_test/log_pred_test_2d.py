...
# -------------------------
# Synthetic dataset: Binary Classification (2 Features)
# -------------------------
...
fig = explain_logistic_prediction(
    ...
    p_hat=p_hat_raw,
    y_hat=y_hat_raw,
    title="Logistic Regression 2D: Predicción (Raw)",
...
fig1 = explain_logistic_prediction(
    ...
    p_hat=p_hat_scaled,
    y_hat=y_hat_scaled,
    title="Logistic Regression 2D (Pipeline): Predicción (Original Space)",
    display_space="original"
)
fig1.show()
...
fig2 = explain_logistic_prediction(
    ...
    p_hat=p_hat_scaled,
    y_hat=y_hat_scaled,
    title="Logistic Regression 2D (Pipeline): Predicción (Scaled Space)",
